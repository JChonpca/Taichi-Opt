...
def exchange(n1: int, 
    ...
    # Envo_SEX 和 Envo_SEX 要一起place, 读取距离会降低（点对点）
    
    for i in range(n1,n2):
        
        # if 0 <= i < n1:
            
        #     Envo_SEX[2*n,i] = Envo_SEX[2*n,i]
            
        #     Envo_SEX[2*n+1,i] = Envo_SEX[2*n+1,i]
                
        # elif n1 <= i < n2:
            
        Envo_SEX[2*n,i] = Envo_SEX[2*n+1,i]   
        
        Envo_SEX[2*n+1,i] = Envo_SEX[2*n,i]        
